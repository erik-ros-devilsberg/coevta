...
import CalendarLoginView from './CalendarLoginView.vue';
...
describe('CalendarLoginView', () => {
	it('signs in and lands on the month grid, staying inside the app scope', async () => {
		...
		// '/' is the grid, relative to the /calendar/ router base — never an
