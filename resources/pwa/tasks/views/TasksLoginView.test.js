...
import TasksLoginView from './TasksLoginView.vue';
...
describe('TasksLoginView', () => {
	...
	it('offers a way out of a forgotten password', () => {
		...
		// the /tasks/ router base, so the app's own router cannot resolve it.
