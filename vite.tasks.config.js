...
// Build config for the Tasks PWA. One config per app: each PWA is a separate
...
// (public/tasks/index.html) and the hand-written service worker precache list
// can reference /tasks/app.js directly — no Blade, no manifest lookup.
//
...
export default defineConfig({
	plugins: [vue()],
	root: 'resources/pwa/tasks',
	build: {
		outDir: '../../../public/tasks',
		emptyOutDir: false,
		rollupOptions: {
			input: fileURLToPath(new URL('./resources/pwa/tasks/main.js', import.meta.url)),
			output: {
